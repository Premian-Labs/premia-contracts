...
abstract contract NonblockingLzApp is LzApp {
    ...
    function _blockingLzReceive(
            ...
            )
        {
            ...
            // error / exception
            l.failedMessages[_srcChainId][_srcAddress][_nonce] = keccak256(
                _payload
            );
    ...
    function retryMessage(
        ...
        bytes32 payloadHash = l.failedMessages[_srcChainId][_srcAddress][
            _nonce
        ];
        require(
        ...
        l.failedMessages[_srcChainId][_srcAddress][_nonce] = bytes32(0);
