...
contract AutoExerciseKeeper is IKeeperCompatible {
    ...
    function addExpirationOrderHash(bytes32 hash, uint256 expiration) public {
        ...
        expirationOrderQueues[expiration][expirationOrderQueueLengths[expiration]] = hash;
    }
    ...
    function checkExercise(AutoExerciseOrder memory order) public view returns (bool) {
