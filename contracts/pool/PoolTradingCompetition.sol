...
library PoolTradingCompetitionStorage {
    bytes32 internal constant STORAGE_SLOT =
        keccak256("premia.contracts.storage.PoolTradingCompetition");
...
contract PoolTradingCompetition is PoolWrite {
    ...
    function getDescending(bool isCall, address addr)
        external
        view
        returns (address)
    {
    ...
    function resetPool(int128 emaVarianceAnnualized64x64) external {
        require(
            msg.sender == 0xFBB8495A691232Cb819b84475F57e76aa9aBb6f1 ||
                msg.sender == 0x573C2AA43D3cD14501Ec116fDC83020Fd479Bb5E,
            "Not admin"
        );
