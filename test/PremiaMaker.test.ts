...
//
//     await p.feeConverter.addWhitelistedRouters([uniswap.router.address]);
...
//     );
//
//     await uniswap.dai.mint(p.feeConverter.address, parseEther('10'));
//
//     await p.feeConverter.convert(uniswap.router.address, uniswap.dai.address);
//
...
//     await uniswap.weth.transfer(p.feeConverter.address, parseEther('10'));
//
//     await p.feeConverter.convert(uniswap.router.address, uniswap.weth.address);
//
...
//       parseEther('10'),
//     );
//     await p.feeConverter.convert(uniswap.router.address, p.premia.address);
//
//     expect(await p.premia.balanceOf(treasury.address)).to.eq(parseEther('2'));
//     expect(await p.premia.balanceOf(p.feeConverter.address)).to.eq(0);
