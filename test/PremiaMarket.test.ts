...
describe('PremiaMarket', () => {
  ...
  describe('createOrderAndTryToFill', () => {
    it('should fill sell orders and not create buy order, if enough sell orders to be filled', async () => {
      ...
      const tx = await premiaMarket
        .connect(taker)
        .createOrderAndTryToFill(newOrder, parseTestToken('3'), [
          order1.order,
          order2.order,
        ]);
    ...
    it('should fill sell orders and create new buy order, if not enough sell order to be filled', async () => {
      ...
      const tx = await premiaMarket
        .connect(taker)
        .createOrderAndTryToFill(newOrder, parseTestToken('7'), [
          order1.order,
          order2.order,
        ]);
  ...
  describe('isOrderValid', () => {
    ...
    describe('sell order', () => {
      ...
      it('should detect sell order as invalid if amount to sell left is 0', async () => {
        ...
        await premiaMarket
          .connect(user1)
          .fillOrder(order.order, parseTestToken('5'));
    ...
    describe('buy order', () => {
      ...
      it('should detect buy order as invalid if amount to buy left is 0', async () => {
        ...
        await premiaMarket
          .connect(user1)
          .fillOrder(order.order, parseTestToken('1'));
  ...
  describe('fillOrder', () => {
    describe('any side', () => {
      ...
      it('should fill multiple orders', async () => {
        ...
        await premiaMarket
          .connect(taker)
          .fillOrders([order1.order, order2.order], parseTestToken('4'));
    ...
    describe('sell order', () => {
      it('should fill 2 sell orders', async () => {
        ...
        await premiaMarket
          .connect(taker)
          .fillOrder(order.order, parseTestToken('2'));
  ...
  describe('delayed writing', () => {
    it('should create a sell order with delayed writing', async () => {
      ...
      await premiaMarket
        .connect(user2)
        .fillOrder(order.order, parseTestToken('0.5'));
