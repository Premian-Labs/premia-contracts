...
export class PoolUtil {
  ...
  static async deploy(
    ...
    const callCoefficients = [
      ...
      -0.00001252615948696122, 31.691783501616406, -0.36571273750619837,
      -0.3231359705060762, 0.01844886762687511, 0.0015410795834495232,
      -0.003794721255223829,
    ];

    const putCoefficients = [
      452.13268592044506, -5.157765245468974, 0.03061344985675325,
      -0.00005802183766289717, -693.0263287794035, 6.883572119363676,
      350.2806123602123, -16.630912821250963, -0.021305491994832955,
      -1.7641242522788132,
    ];
